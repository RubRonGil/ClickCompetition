...
public class CountryController {
    ...
    @GetMapping(value = "/country/clasification")
    public ResponseEntity<Object> bestCountry() {
        return new ResponseEntity<>(countryRepository.contryOrderByClicks(), HttpStatus.OK);
    }
}
