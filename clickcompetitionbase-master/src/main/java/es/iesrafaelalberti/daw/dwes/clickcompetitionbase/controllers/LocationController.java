...
public class LocationController {
    ...
    @GetMapping(value = "/location/clasification")
    public ResponseEntity<Object> bestLocations() {
        return new ResponseEntity<>(locationRepository.locationsOrderByClicks(), HttpStatus.OK);
    }
}
