...
public class RegionController {
    ...
    @GetMapping(value = "/region/clasification")
    public ResponseEntity<Object> bestRegions() {
        return new ResponseEntity<>(regionRepository.regionsOrderByClicks(), HttpStatus.OK);
    }
